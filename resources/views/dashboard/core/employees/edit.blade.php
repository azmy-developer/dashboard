                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="inputState" class="select2 form-control"
                                    ...
                                    @foreach($departments as $department)
                                        <option {{$department->id == $model->department_id ? 'selected' : ''}} value="{{$department->id}}">{{$department->title}}</option>
                                    @endforeach
                                </select>
                                @error('department_id')
                                <div class="alert alert-danger">{{ $message }}</div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="inputState" class="select2 form-control"
                                    ...
                                    @foreach($roles as $role)
                                        <option
                                            {{$model->hasRole($role->name) ? 'selected' : ''}} value="{{$role->name}}">{{$role->name}}</option>
                                    @endforeach
                                </select>
                                @error('roles')
                                <div class="alert alert-danger">{{ $message }}</div>
